...
export default function HowItWorks() {
  ...
  return (
    <section className="relative py-28 px-4 md:px-6 bg-[linear-gradient(135deg,var(--color-bg),rgba(0,0,0,0.015))] overflow-hidden transition-colors">
      {/* Glow Background */}
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="flex-1">
          <div className="text-center md:text-left mb-12">
            ...
            <p className="mt-4 text-lg text-[var(--color-text-secondary)] max-w-2xl mx-auto md:mx-0">
          ...
          <div className="relative space-y-16 border-l-[3px] border-dashed border-[var(--color-border)] pl-10 before:absolute before:top-0 before:left-[8px] before:h-full before:w-[3px] before:bg-gradient-to-b before:from-[var(--color-primary)] before:to-transparent before:rounded-full">
            {steps.map(({ icon: Icon, title, desc, imageLight, imageDark }, index) => (
              ...
              >
                {/* Glowing Dot */}
                <div className="absolute -left-[24px] top-2 w-5 h-5 bg-[var(--color-primary)] rounded-full shadow-lg shadow-[var(--color-primary)] group-hover:scale-110 transition-transform" />

                {/* Step Card */}
                <div className="bg-[var(--color-card)] border border-[var(--color-border)] p-6 md:p-7 rounded-2xl shadow-xl hover:shadow-2xl hover:scale-[1.02] transition duration-300">
